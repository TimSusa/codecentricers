// Codecentricers Frontend Build with variants and flavors
//
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      dist: {
        files: [{
          ...
          src: [
            ...
            'scripts/codecentricers.*',
            'styles/codecentricers.*'
          ]
        }]
      }
    },
    ...
    html2js: {
      main: {
        options: {
          ...
          module: 'codecentricers.templates.html',
          singleModule: true,
          htmlmin: {
    ...
    //     options: {
    //       base: '<%= config.build %>',
    //       module: 'codecentricers.templates.json',
    //     },
