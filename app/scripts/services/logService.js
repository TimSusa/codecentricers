...
/**
  * @ngdoc service
  * @name codecentricers.service:logService
...
.factory('logService', [ '$injector', function ($injector) {
  ...
  var service = {
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#toggleDebug
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#setDelegate
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#logException
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#callSuccess
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#callFailed
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#getExceptions
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#getMessages
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#getCalls
      * @methodOf codecentricers.service:logService
      * @kind function
      *
    ...
    /**
      * @ngdoc method
      * @name codecentricers.service:logService#getDiagnosticMessage
      * @methodOf codecentricers.service:logService
      * @kind function
      *
...
/**
  * @ngdoc service
  * @name codecentricers.service:traceService
  * @module codecentricers
  * @kind service
  *
  * @description
...
/**
  * @ngdoc service
  * @name codecentricers.service:$exceptionHandler
  * @module codecentricers
  * @kind service
  * @requires codecentricers.services:logService
  * @requires codecentricers.services:traceService
  *
  * @description
