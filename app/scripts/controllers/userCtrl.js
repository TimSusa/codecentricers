 ...
 * @requires $log
 * @requires $q
 * @requires codecentricers.resources.service:User
 * @requires codecentricers.resources.service:Auth
...
.controller('UserCtrl', [ '$scope', '$injector', function ($scope, $injector) {
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#login
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
    * Performs user login via the {@link codecentricers.service:authService AuthService}. This method
    ...
    *
    * @returns {Promise}  API call promise that resolves to a {@link codecentricers.resources.service:User User} object
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#logout
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
    * Performs user logout via the {@link codecentricers.service:authService AuthService}.
    *
    */
  // function logout () {
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#create
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
    * Performs user create via the {@link codecentricers.service:authService AuthService}. This method
    * uses the following data fields exported by the controller:
    *
    * - **data.name** - `{string}` user name
    * - **data.password** - `{string}` user password
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#register
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
    * Registers a user's email address for invitation via {@link codecentricers.service:authService AuthService}.
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#changeEmail
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
    ...
    * {@link codecentricers.controller:EmailVerifyCtrl EmailVerifyCtrl}.
    *
    * This method uses the following data fields exported by the controller:
    *
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#changeProfile
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#verifyEmail
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#closeAccount
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#changePwd
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#requestPwd
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
    ...
    * {@link codecentricers.controller:PasswordResetCtrl PasswordResetCtrl}.
    *
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:UserCtrl#resetPwd
    * @methodOf codecentricers.controller:UserCtrl
    * @kind function
    *
    * @description
