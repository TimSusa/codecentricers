 ...
 *
 * * `appVersion` - `{object}` - application-wide {@link codecentricers.objects:version build info}
 * * `customer` - `{object}` - customer object from {@link codecentricers.objects:globals global configuration}
 * * `features` - `{object}` - feature object from {@link codecentricers.objects:globals global configuration}
 *
 * @example
 * ```html
    <html lang="{{site.getLang()}}" class="no-js" ng-app="codecentricers"
...
.controller('SiteCtrl', ['$scope', '$injector', function ($scope, $injector) {
  ...
  /**
    * @ngdoc method
    * @name codecentricers.controller:SiteCtrl#getSiteClasses
    * @methodOf codecentricers.controller:SiteCtrl
    * @kind function
    *
    * @description
